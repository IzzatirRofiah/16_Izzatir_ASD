...
//        }
    ...
    public Node16 addRecursive(Node16 current, int data) {
        if (current==null) {
    ...
    public Node16 getSuccessor(Node16 delNode) {
        Node16 successorParent = delNode;
        Node16 successor = delNode;
        Node16 current = delNode.right;
        while (current != null) {
    ...
    public void displayLeafData(Node16 node) {
        if (node == null) {
            return;
        }
    ...
    public int countLeafNodesRekursif(Node16 node) {
        if (node == null) {
            return 0;
        }
        if (node.left == null && node.right == null) {
