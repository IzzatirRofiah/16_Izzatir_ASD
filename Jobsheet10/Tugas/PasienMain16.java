...
public class PasienMain16 {
    ...
    public static void main(String[] args) {
        ...
        PasienQueue16 antri = new PasienQueue16(jumlah);
        int pilih;
        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    int umur = sc.nextInt();
                    Pasien16 pasien = new Pasien16(nama, noID, jenisKelamin, umur);
                    antri.enqueue(pasien);
                    break;
                case 2:
                    Pasien16 keluar = antri.dequeue();
                    if (keluar != null) {
